                ...
                <div class="card border-0 shadow-sm">
                    <div class="row g-0">
                        ...
                        <div class="col-lg-8 position-relative">
                            @if ($post->image)
                                <img src="{{ asset($post->image) }}" class="img-fluid w-100 h-100 object-fit-cover"
                                    style="max-height: 600px;" alt="{{ $post->caption }}">
                            @endif
                                ...
                                {{-- <div class="border-top pt-4">
                                    ...
                                    <div class="comments-container" style="max-height: 300px; overflow-y: auto;">
                                        ...
                                        <div class="d-flex mb-3">
                                            <img src="{{ asset('images/Blank-Profile-Picture.webp') }}" alt="Commenter"
