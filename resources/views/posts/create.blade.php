                    ...
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Share your ideas</small>
                            </div>
                        </div>
                        ...
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="position-relative mb-4 text-center">
                                ...
                                <div
                                    class="upload-area p-5 rounded bg-light text-center @error('image') border border-danger @enderror">
                            ...
                            <div class="mb-4">
                                <textarea name="caption" id="caption" rows="3"
                                    ...
                                    placeholder="Describe your idea">{{ old('caption') }}</textarea>
                                @error('caption')
                            ...
                            <div class="mb-4">
                                <select name="category" id="category" name="category" class="form-control @error('category') is-invalid @enderror">
                            ...
                            <div class="d-flex gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-paper-plane me-2"></i>Go public
                                </button>
                            </div>
                        </form>
                    </div>
